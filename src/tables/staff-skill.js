 ...
 */
export const tableStaffSkill = {
    tableColumns: tableStaffSkillCol,
    tableKey: "id",
    selectType: 'none',
    showFullSize: true,
 ...
 * name：在技能点击时候，会将该字段值传回，用于确定哪个label被点击
 * color: 按钮颜色
 */
export const tableStaffSkillOperation = [
    {
        label: '编辑',
        condition: 'updateOp',
        name: 'update',
